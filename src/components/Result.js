...
const data = [
  {
    ...
    description2:
      "💔 당신과 맞지 않는 캐릭터: 헤르미온느 그레인저\n자기 주장이 너무 강한 인물과의 사랑은 상처만 남을 거예요.",
  },
  {
    title: "웬즈데이 아담스",
  ...
  return (
    <div className="Result">
      <Box
        ...
        sx={{
          p: "100px 30px",
          backgroundImage: `url(https://static.kinolights.com/mbti/202307-fate/female-r${id}.jpg)`,
